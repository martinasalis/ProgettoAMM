...
public class Profilo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("loggedIn") == null || session.getAttribute("loggedIn").equals(false)){
            ...
            session.setAttribute("UserNotAuthenticated", true);
            request.getRequestDispatcher("profilo.jsp").forward(request, response);
            
        }
        else if(session.getAttribute("loggedIn") != null && session.getAttribute("loggedIn").equals(true)){
            ...
            session.setAttribute("profileModified", true);
            request.getRequestDispatcher("profilo.jsp").forward(request, response);
        }
        else{
